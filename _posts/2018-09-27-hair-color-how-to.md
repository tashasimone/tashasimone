...
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/HCHT/cover.jpg" alt="how to manual"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/HCHT/spread.jpg" alt="how to manual"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/HCHT/spread-stand.jpg" alt="how to manual"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/HCHT/detail-1.jpg" alt="how to manual"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/HCHT/detail-2.jpg" alt="how to manual"/></div>
</div>
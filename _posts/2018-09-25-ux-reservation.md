...
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/UXR/cover-hand.jpg" alt="process book" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/UXR/spread-1.jpg" alt="process book" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/UXR/spread-2.jpg" alt="process book" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/UXR/spread-3.jpg" alt="process book" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/UXR/spread-4.jpg" alt="process book" /></div>
</div>
...
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/YFC/cover-2.jpg" alt="trifold brochure" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/YFC/panel-1.jpg" alt="trifold brochure" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/YFC/panel-2.jpg" alt="trifold brochure" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/YFC/spread-1.jpg" alt="trifold brochure" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/YFC/spread-2.jpg" alt="trifold brochure" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/YFC/spread-3.jpg" alt="trifold brochure" /></div>
</div>
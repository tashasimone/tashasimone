...
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/home-desktop.png" alt="website mockup" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/about-desktop.png" alt="website mockup" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/book-desktop.png" alt="website mockup" /></div>
</div>

<h2 class="detail-head">Tablet Screens</h2>
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/home-tablet.png" alt="website mockup" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/about-tablet.png" alt="website mockup" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/book-tablet.png" alt="website mockup" /></div>
</div>

<h2 class="detail-head">Mobile Screens</h2>
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/home-mobile.png" alt="website mockup" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/about-mobile.png" alt="website mockup" /></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/BAR/book-mobile.png" alt="website mockup" /></div>
</div>
...
<div class="row post-imgs">
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/LOTR/full-2.jpg" alt="poster"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/LOTR/mid.jpg" alt="poster"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/LOTR/detail-1.jpg" alt="poster"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/LOTR/detail-2.jpg" alt="poster"/></div>
    <div class="card"><img class="detail" src="{{site.baseurl}}/assets/LOTR/detail-3.jpg" alt="poster"/></div>
</div>